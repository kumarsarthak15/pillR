    ...
    <>
      <section className="bg-medigrab-navy py-20">
        <div className="mx-auto max-w-container px-6 max-w-4xl">
          ...
          <p className="text-lg md:text-xl text-medigrab-muted">
            Questions, partnerships, press enquiries — we&apos;re here.
          </p>
        </div>
      </section>

      <section className="bg-medigrab-card py-16 md:py-20">
        <div className="mx-auto max-w-container px-6 grid gap-10 md:grid-cols-2">
          <div className="space-y-4">
            <div className="rounded-[20px] bg-medigrab-section p-6 border-l-4 border-whatsapp">
              ...
              <p className="text-sm text-medigrab-muted mb-4">
            ...
            <ContactCard Icon={Mail} title="Email">
              <a href={`mailto:${SITE_CONFIG.email}`} className="text-medigrab-teal hover:underline break-all">
                {SITE_CONFIG.email}
              </a>
            </ContactCard>

            <ContactCard Icon={Phone} title="Phone">
              <a href={`tel:${SITE_CONFIG.phone.replace(/\s/g, "")}`} className="text-medigrab-teal hover:underline">
                {SITE_CONFIG.phone}
              </a>
            </ContactCard>
          ...
          <div className="rounded-[20px] bg-medigrab-section p-6 md:p-8 border border-white/5">
...
function ContactCard({
  ...
  return (
    <div className="rounded-[20px] bg-medigrab-section p-6">
      <div className="flex items-center gap-3 mb-2">
        <Icon className="text-medigrab-teal" size={20} />
