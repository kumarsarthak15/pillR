...
export default function NotFound() {
  return (
    <section className="bg-medigrab-navy min-h-[70vh] flex items-center">
      <div className="mx-auto max-w-container px-6 text-center">
        <div className="mb-8 flex justify-center">
          <svg viewBox="0 0 200 80" width="160" height="64" aria-hidden="true">
            <g>
              ...
              <rect x="100" y="20" width="80" height="40" rx="0" fill="#1DB89A" />
        ...
        <p className="text-medigrab-muted mb-8 max-w-md mx-auto">
