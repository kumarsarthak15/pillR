...
export function Footer() {
  ...
  return (
    <footer className="bg-medigrab-navy border-t border-medigrab-section">
      <div className="mx-auto max-w-container px-5 md:px-6 py-10 md:py-14 grid gap-8 md:gap-10 md:grid-cols-4">
        <div className="md:col-span-1 space-y-4">
          <Logo size="lg" />
          <p className="text-sm text-medigrab-muted leading-relaxed max-w-[260px]">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            {NAV_LINKS.map((n) => (
              <li key={n.href}>
                <Link href={n.href} className="text-medigrab-muted hover:text-white transition-colors">
                  {n.label}
                </Link>
              </li>
            ))}
        ...
        <div>
          ...
          <address className="not-italic text-sm text-medigrab-muted leading-relaxed space-y-1">
            ...
            {SOCIAL_LINKS.map((s) => {
              ...
              return (
                <a
                  ...
                  aria-label={s.label}
                  className="text-medigrab-muted hover:text-medigrab-teal transition-transform duration-base hover:scale-[1.15]"
                >
                  <Icon size={20} />
                </a>
              );
      ...
      <div className="border-t border-medigrab-section">
        <div className="mx-auto max-w-container px-5 md:px-6 py-5 flex flex-col gap-3 text-[12px] md:text-[13px] text-medigrab-muted md:flex-row md:items-center md:justify-between">
